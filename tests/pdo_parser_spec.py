...
class TestPDO(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.index_1A02_0 = MagicMock(access_type='ro', data_type='0x0005', default_type=1, id='1A02', object_type='0x7'
                                      , parameter_name='Number of mapped objects', sub_id=0, default_value=0xFE)

        self.index_1A02 = MagicMock(id='1A02', parameter_name='TPDO mapping parameter', object_type='0x9',
                                    sub_number='0x5',
                                    sub_indices=[self.index_1A02_0])

        # 1A03 - MPDO DAM mapping
        self.index_1A03_0 = MagicMock(access_type='ro', data_type='0x0005', default_type=1, id='1A03', object_type='0x7'
                                      , parameter_name='Number of mapped objects', sub_id=0, default_value=0xFF)

        self.index_1A03 = MagicMock(id='1A03', parameter_name='TPDO mapping parameter', object_type='0x9',
                                    sub_number='0x5',
